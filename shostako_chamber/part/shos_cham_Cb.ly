...
\book{
  \header {
    ...
    instrument = \markup{\bold "Kontrabaß"}
  }
  ...
  \score {
    ...
    \new ChoirStaff \with{\RemoveAllEmptyStaves} \with{midiInstrument = #"contrabass"}<<
      \new Staff{
        <<
          {
    ...
    \new ChoirStaff \with{\RemoveAllEmptyStaves} \with{midiInstrument = #"contrabass"}<<
      \new Staff {
        <<
          ...
          {
            \include "../data/shos_cham_Vn1-2_cueForCb.lyi"
          }
        >>
      }
      \new Staff {
        <<
          ...
          {
            \include "../data/shos_cham_Vc-2_cue.lyi"
          }
        >>
      }
      \new Staff \with{\consists Page_turn_engraver}{
